...
mod tests {
    ...
    fn test_ffmpeg_args() {
        ...
        assert_eq!(
            AudioFormat::Opus.ffmpeg_args(),
            vec!["-c:a", "libopus", "-b:a", "192k"]
        );
    }
    ...
    fn test_from_user_input_numbers() {
        assert_eq!(AudioFormat::from_user_input("1").unwrap(), AudioFormat::Mp3);
        assert_eq!(
            AudioFormat::from_user_input("2").unwrap(),
            AudioFormat::AacCopy
        );
        assert_eq!(
            AudioFormat::from_user_input("3").unwrap(),
            AudioFormat::Opus
        );
    }
    ...
    fn test_from_user_input_names() {
        assert_eq!(
            AudioFormat::from_user_input("mp3").unwrap(),
            AudioFormat::Mp3
        );
        assert_eq!(
            AudioFormat::from_user_input("MP3").unwrap(),
        ...
        assert_eq!(
            AudioFormat::from_user_input("aac").unwrap(),
            AudioFormat::AacCopy
        );
        assert_eq!(
            AudioFormat::from_user_input("AAC").unwrap(),
        ...
        assert_eq!(
            AudioFormat::from_user_input("aac-copy").unwrap(),
            AudioFormat::AacCopy
        );
        assert_eq!(
            AudioFormat::from_user_input("opus").unwrap(),
            AudioFormat::Opus
        );
        assert_eq!(
            AudioFormat::from_user_input("OPUS").unwrap(),
    ...
    fn test_description() {
        ...
        assert_eq!(
            AudioFormat::AacCopy.description(),
            "AAC (直接复制, 速度最快, 零损耗)"
        );
